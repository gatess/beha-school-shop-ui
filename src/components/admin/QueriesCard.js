  ...
  return (
    <Widget>
      <div className="gx-d-flex">
        <p className="gx-text-uppercase gx-chart-title">Sipariş</p>
        <p className="gx-ml-auto gx-text-primary">/Ay</p>
      </div>
      <Row>
        <Col lg={6} md={6} sm={24} xs={24} className="gx-pr-2">
          <div className="gx-pt-2">
            <h2 className="gx-fs-xxxl gx-font-weight-medium gx-mb-1 gx-text-black">543</h2>
            <p className="gx-mb-2 gx-mb-md-0">Sipariş sayısı.</p>
          </div>
        </Col>
